  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/mylisting'
       ...
       <Route path='/payment'
       element={userData != null ? <Payment/>:<Navigate to={"/"}/>}/>
       <Route path='/admin'
       element={userData != null && userData.role === 'admin' ? <AdminDashboard/>:<Navigate to={"/"}/>}/>
       <Route path='/dashboard'
       element={userData != null ? <UserDashboard/>:<Navigate to={"/"}/>}/>
