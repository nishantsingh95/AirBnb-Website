...
function ViewCard() {
  ...
  let { cardDetails, setRefreshTrigger } = useContext(listingDataContext)
  ...
  let [totalQuantity, setTotalQuantity] = useState(cardDetails.totalQuantity || 1)
  let [ratings, setRatings] = useState(cardDetails.ratings || 0)
    ...
    <div className='w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto  relative'>
      ...
      {updatePopUp && <div className='w-[100%] h-[100%] flex items-center justify-center  bg-[#000000c6] absolute top-[0px] z-[100] backdrop-blur-sm'>
        ...
        >
          ...
          <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
            <label htmlFor="quantity" className='text-[20px]'>Number of Properties Available</label>
            <input type="number" id='quantity' min="1" className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]' required onChange={(e) => setTotalQuantity(parseInt(e.target.value))} value={totalQuantity} placeholder='How many units available?' />
            <p className='text-sm text-gray-400'>Specify how many identical properties/units are available for booking</p>
          </div>
          <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
            <label htmlFor="ratings" className='text-[20px]'>Rating</label>
            <input type="number" id='ratings' min="0" max="5" step="0.1" className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]' required onChange={(e) => setRatings(parseFloat(e.target.value))} value={ratings} placeholder='Rating (0-5)' />
            <p className='text-sm text-gray-400'>Update the property rating (0-5)</p>
          </div>
        ...
        <form className='max-w-[450px] w-[90%] h-[450px] overflow-auto bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-start flex-col gap-[10px]    border-[1px] border-[#dedddd]' onSubmit={(e) => {
          ...
          <div className='w-[100%] h-[70%] mt-[10px] rounded-lg p-[10px]'>
            ...
            <div className='w-[100%] flex items-center justify-center'>
              <button className='px-[80px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px]  rounded-lg  text-nowrap mt-[30px] ' onClick={() => {
